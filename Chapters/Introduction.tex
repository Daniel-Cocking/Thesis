...
\section{History of \texorpdfstring{$^2$H}{2H} Usage in Studying Metabolism}
...
% Chapter four gives an overview of some of the research that has been conducted so far in deuterium metabolic imaging (DMI) predicts the potential benefits of using glucose-d$_7$ as opposed to glucose-d$_2$. 
